{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 6.0, 65.0, 1076.0, 681.0 ],
		"bglocked" : 0,
		"defrect" : [ 6.0, 65.0, 1076.0, 681.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 72.0, 27.0, 150.0, 31.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 27.0, 18.0, 251.0, 19.0 ],
					"text" : "start the TuioPad app and connect to port 3333"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 240.0, 153.0, 199.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 189.0, 131.0, 275.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 623.0, 44.0, 157.0, 19.0 ],
					...
					"patcher" : 					{
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"patching_rect" : [ 67.821503, 204.313141, 46.0, 19.0 ],
									"text" : "t 1 b 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 67.821503, 231.313141, 52.0, 19.0 ],
									"text" : "gate 1 1"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 37.821507, 213.313141, 19.0, 19.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 125.0, 180.0, 233.0, 19.0 ],
									"text" : "Additional parameters can be defined here"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 36.0, 18.0, 290.0, 19.0 ],
...
,
					"patching_rect" : [ 202.0, 356.0, 50.0, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"fontname" : "Verdana",
						"default_fontname" : "Verdana",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 82.0, 306.0, 56.0, 19.0 ],
					"text" : "jcom.in"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 82.0, 356.0, 52.0, 19.0 ],
					"text" : "jalg.tuio"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 13.0, 198.0, 526.0, 19.0 ],
					"text" : "jcom.hub @module_type control @description \"This module receives data from a Tuio enabled device\"",
					"varname" : "jcom.hub"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 277.0, 342.0, 220.0, 17.0 ],
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 91.5, 337.5, 487.5, 337.5 ],
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 91.5, 337.5, 211.5, 337.5 ],
					"source" : [ "obj-24", 0 ]
				}
